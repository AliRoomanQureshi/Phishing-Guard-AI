...
Frontend: A vanilla JavaScript dynamic interface containing an animated threat matrix and probability color-scales.
Deterministic Heuristics Framework: Real-time interceptions of known spoofing vectors, including Hex/Integer IPs, IDN Homographs, credential trick URLs, and Cloud script abuse.
Core ML Ensemble: The dual-architecture AI combining:
